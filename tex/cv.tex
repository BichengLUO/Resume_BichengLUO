...
\address{The Institute of CG\&CAD, School of Software, Tsinghua University}{Beijing}{China}
...
\item Marked the course assignments and the final test, delivered lectures and Q\&A
\end{itemize}
}
...
\cvlistitem{Excellence in the Nation Level, Innovation and Entrepreneurial Project at Nanjing University,\\Project ID: G1210284071 (Awarded to 18 projects out of 170)
...
\begin{enumerate}[{[1]}]
\item \cvitem{}{\textbf{Bicheng Luo}, Feng Xu, Jun-Hai Yong. DepVR: 360$^{\circ}$ Scene Representation Based on Implicit Depth. In the Proceeding of IEEE Virtual Reality (IEEE VR 2017).
}
...
\cvlistitem{\textbf{\href{http://webglbrush.sinaapp.com/}{WebGLBrush}}: The graduation project in Nanjing University, a WebGL-based 3D sculpture modeling system, inspired by ZBrush}
\cvlistitem{\textbf{\href{https://github.com/BichengLUO/ImageProcessing}{ImageProcessing}}: A photo editing tool based on MFC and OpenCV, the course project for Digital Image Processing, including
